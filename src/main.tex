...
\title{Egenskaper hos Internet of Things - plattformar}
% 2-osainen otsikko:
...
\TITLE{Egenskaper hos Internet of Things-plattformar}
...
\PAAAINE{Programvaruproduktion och -affärsverksamhet}
\CODE{T3003}
...
\renewcommand{\refname}{Källor}  % article-tyyppisen
